...
### Import từ package
```python
from RAG_system.CHUNKERS import (
...
```python
from RAG_system.CHUNKERS.model import Chunk, Score, ProvenanceAgg
```

### Import legacy (tương thích ngược)
```python
from RAG_system.CHUNKERS.model import ChunkType, Chunk  # Vẫn hoạt động
```
