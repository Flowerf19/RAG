...
class Text:
    ...
    def extract_text_blocks_for_page(
        ...
        if enable_block_merging:
            from RAG_system.LOADER.normalizers.text_utils import merge_blocks_list
            merge_config = {
    ...
    def should_filter_block(
        ...
        """
        from RAG_system.LOADER.normalizers.text_utils import (
            is_repeated_block,
    ...
    def build_block_hash_counter(all_blocks: List[List[Any]]) -> Counter:
        ...
        """
        from RAG_system.LOADER.normalizers.text_utils import compute_block_hash
