...
MIT License — xem file LICENSE ở gốc repo.

---

Nếu cần, tôi có thể:
- Tạo file README.md này trong thư mục reranking của repo.
- Viết ví dụ cụ thể hơn cho provider bạn đang dùng (HF local/API, Ollama, v.v).